...
import random
# importing Data
df_house = pd.read_csv(r'C:\Users\Gebruiker\Downloads\households.csv', sep=',')
df_trips = pd.read_csv(r'C:\Users\Gebruiker\Downloads\trips.csv', sep=',')
df_persons = pd.read_csv(r'C:\Users\Gebruiker\Downloads\persons.csv', sep=',')
...
#reference for regions, don't think it's gonna be used
main = ['75', '92']
petite_others = ["77", "93"]
grande = ["78", "91", "94", "95"]

# Distribute trips randomly between chosen zones based on probabilities
# production_75 = 0
# production_77 = 0
# production_78 = 0
# production_91 = 0
...
#for i in range(10):
#zone 93
#print(df3.loc[(df3["zone"] == "93")])
frac_93 = 0.28
# work_93 = np.array(["75", "92", "93"])
work_93 = np.array(["75", "92", "94", "93"])
p_93 = (0.28*0.5, 0.28*0.3, 0.28*0.2, 1-0.28)
#df3_93 = df3.loc[((df3["zone"] == "93") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work")))]
...
for i in range(len(((df3["zone"] == "93") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))))):
    ...
    if (df3.loc[i, "zone"] == "93") & ((df3.loc[i, "following_purpose"] == "work") | (df3.loc[i, "preceding_purpose"] == "work")):
        #df3.iloc[((df3["zone"] == "93") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))), "workplace"] = a
        df3.loc[i, "workplace"] = a
#print(df3)
#print(df3.loc[(df3["zone"] == "93")])

#df3.loc[((df3["zone"] == "93") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))),
            #"workplace"] = np.random.choice(work_93, replace=False, p=p_93).tolist()

#df3 = df3.drop(columns=["household_id", "person_id", "nr_trips"])
#print(df3.loc[(df3["zone"] == "93")])
#zone 94
frac_94 = 0.24
# # work_94 = np.array(["75", "92", "94"])
work_94 = np.array(["75", "92", "93", "94"])
p_94 = (0.24*0.5, 0.24*0.3, 0.24*0.2, 1-0.24)
# df3.loc[((df3["zone"] == "94") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))),
#             "workplace"] = np.random.choice(work_94, replace=False, p=p_94)
...
for i in range(len(((df3["zone"] == "78") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))))):
    ...
    if (df3.loc[i, "zone"] == "78") & ((df3.loc[i, "following_purpose"] == "work") | (df3.loc[i, "preceding_purpose"] == "work")):
        #df3.iloc[((df3["zone"] == "93") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))), "workplace"] = a
        df3.loc[i, "workplace"] = a
# df3.loc[((df3["zone"] == "78") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))),
        #"workplace"] = np.random.choice(work_78, replace=False, p=p_78)
...
#df3.loc[((df3["zone"] == "91") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))),
        #"workplace"] = np.random.choice(work_91, replace=False, p=p_91)
...
for i in range(len(((df3["zone"] == "95") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))))):
    ...
    if (df3.loc[i, "zone"] == "95") & ((df3.loc[i, "following_purpose"] == "work") | (df3.loc[i, "preceding_purpose"] == "work")):
        #df3.iloc[((df3["zone"] == "93") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))), "workplace"] = a
        df3.loc[i, "workplace"] = a
#df3.loc[((df3["zone"] == "95") & ((df3["following_purpose"] == "work") | (df3["preceding_purpose"] == "work"))),
        #"workplace"] = np.random.choice(work_95, replace=False, p=p_95)
...
#print(production_75, production_77, production_78, production_91, production_92, production_93, production_94,
#      production_95)
#print(attraction_75, attraction_77, attraction_78, attraction_91, attraction_92, attraction_93, attraction_94,
#      attraction_95)

#df3 = df3.drop(columns=["household_id", "person_id", "age"])
