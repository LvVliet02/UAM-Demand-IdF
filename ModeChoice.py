...
u_pt = a_pt + b_trv_pt * x_trv_pt + b_egs_pt * x_egs_pt + b_wait_pt * x_wait_pt + b_trs_pt * x_trs_pt + b_c * ((x_cdis / th_acdis) ** l_dis_c) * ((x_inc / th_ai) ** l_inc_c) * c_pt

u_uam = a_uam + b_trv_uam * x_trv_uam + b_c * ((x_cdis / th_acdis) ** l_dis_c) * ((x_inc / th_ai) ** l_inc_c) * c_uam + b_trs_uam * x_trs_uam + u_acsm + u_egsm
